...
Al igual que con las referencias cruzadas, $\text{\LaTeX}$ hace un maravilloso trabajo con las citas de referencias bibliográficas. Para ello se apoya en otro programa de gestión de referencias bibliográficas llamado [BibTeX](http://www.bibtex.org/), que viene incluido en la distribución estándar de $\text{\LaTeX}$. BibTeX permite crear una base de datos de distintos tipos de documentos que después se pueden citar en nuestro documento y después listar al final del documento las referencias bibliográficas citadas con diferentes formatos.
