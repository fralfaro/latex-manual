...
El argumento opcional indica la preferencia de ubicación de la figura en la página (`h` en el lugar en el que aparece en el código fuente, `t` arriba, `b` abajo). $\text{\LaTeX}$ intentará ubicar la figura en esa posición salvo que no sea posible.
