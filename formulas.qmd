...
[^1]: Para un listado más exhaustivo de los símbolos matemáticos de $\LaTeX$, puede consultarse el documento [The Great, Big List of $\LaTeX$ Symbols](https://www3.nd.edu/~nmark/UsefulFacts/LaTeX_symbols.pdf).
