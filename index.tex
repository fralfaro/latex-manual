...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colback=white, left=2mm, toprule=.15mm, coltitle=black, titlerule=0mm, opacityback=0, colframe=quarto-callout-important-color-frame, breakable, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colback=white, left=2mm, toprule=.15mm, coltitle=black, titlerule=0mm, opacityback=0, colframe=quarto-callout-warning-color-frame, breakable, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colback=white, left=2mm, toprule=.15mm, coltitle=black, titlerule=0mm, opacityback=0, colframe=quarto-callout-note-color-frame, breakable, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, title={Salida}, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colback=white, left=2mm, toprule=.15mm, coltitle=black, titlerule=0mm, opacityback=0, colframe=quarto-callout-caution-color-frame, breakable, toptitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, opacitybacktitle=0.6]
...
\CommentTok{\% CUERPO}
\KeywordTok{\textbackslash{}begin}\NormalTok{\{}\ExtensionTok{document}\NormalTok{\}}
\NormalTok{El principal libro sobre latex es }\KeywordTok{\textbackslash{}cite}\NormalTok{\{}\ExtensionTok{lamport\_latex\_1994}\NormalTok{\}, aunque también es muy interesante el artículo }\KeywordTok{\textbackslash{}cite}\NormalTok{\{}\ExtensionTok{borbon\_latex\_2022}\NormalTok{\}}
