...
Para ello tendremos que crear un fichero de texto con el nombre `main.tex` (es importante que la extensión de los ficheros con código fuente de $\LaTeX$ sea `.tex`) y el siguiente contenido:
