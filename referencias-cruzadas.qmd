...
Otro de los puntos fuertes de $\text{\LaTeX}$ es la gestión de las referencias cruzadas, es decir, referencias a otras partes del documento, así como las notas a pie de página.
...
% CUERPO
\begin{document}
El logotipo de latex es $\text{\LaTeX}$.\footnote{Fue creado por Leslie Lamport.}
\end{document}
```
